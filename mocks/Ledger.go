...
func (_m *Ledger) Address(displayHRP string, addressIndex uint32) (ShortID, error) {
	ret := _m.Called(displayHRP, addressIndex)

	var r0 ShortID
	if rf, ok := ret.Get(0).(func(string, uint32) ShortID); ok {
		r0 = rf(displayHRP, addressIndex)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ShortID)
		}
	}
...
func (_m *Ledger) Addresses(numAddresses int) ([]ShortID, error) {
	ret := _m.Called(numAddresses)

	var r0 []ShortID
	if rf, ok := ret.Get(0).(func(int) []ShortID); ok {
		r0 = rf(numAddresses)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ShortID)
