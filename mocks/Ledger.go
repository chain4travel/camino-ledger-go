...
func (_m *Ledger) Address(displayHRP string, addressIndex uint32) (ledger.ShortID, error) {
	ret := _m.Called(displayHRP, addressIndex)

	var r0 ledger.ShortID
	if rf, ok := ret.Get(0).(func(string, uint32) ledger.ShortID); ok {
		r0 = rf(displayHRP, addressIndex)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ledger.ShortID)
		}
	}
...
// Addresses provides a mock function with given fields: numAddresses
func (_m *Ledger) Addresses(numAddresses int) ([]ledger.ShortID, error) {
	ret := _m.Called(numAddresses)

	var r0 []ledger.ShortID
	if rf, ok := ret.Get(0).(func(int) []ledger.ShortID); ok {
		r0 = rf(numAddresses)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ledger.ShortID)
